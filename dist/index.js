...
const getNativeRange = function getNativeRange() {
...
const setNativeRange = function setNativeRange(
...
const update = function update(source = Emitter.sources.USER) {
...
const handleDragging = function handleDragging() {
